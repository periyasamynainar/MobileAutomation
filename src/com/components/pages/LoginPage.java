...
public class LoginPage extends JSN_Framework {
	...
	public static final String SaveUserName = "//*[@class='mm-c-login__username']";
	
	/*public static final String HomUserName = "//android.widget.EditText[@index='1']";
	
	public static final String HomPwd = "//android.widget.EditText[@text='USERNAME']";
	public static final String HomLogin = "//android.widget.Button[@index='5']";*/
	//public static final String SaveUserName = "//*[@class='mm-c-login__username']";
